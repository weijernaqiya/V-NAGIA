...
export const getFragmentTimelineStyle = () => {
  ...
  const variables = {
    ...
    '--delay-fragment-image': seconds(timeline.panelReveal.image),
    '--delay-fragment-cinema': seconds(timeline.panelReveal.cinema),
    '--delay-fragment-music': seconds(timeline.panelReveal.music),
    '--delay-fragment-games': seconds(timeline.panelReveal.games),
